...
| 테스트 | `cargo nextest run --workspace --all-features` + `cargo test --workspace --all-features --doc` | ubuntu / macos / windows × stable / beta / MSRV 1.85 |
...
| MSRV | `cargo msrv verify --workspace` | `[workspace.package].rust-version = "1.85"` 강제 |
